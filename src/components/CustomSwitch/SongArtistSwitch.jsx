...
export default function SongArtistSwitch({ onChange }) {
    ...
    const handleChange = (event) => {
        ...
        // Call the callback function from the parent component with the updated value
        if (onChange) {
            onChange(newValue);
        }
    };

    return <MUISwitch onChange={handleChange} checked={switchValue}/>;
}
